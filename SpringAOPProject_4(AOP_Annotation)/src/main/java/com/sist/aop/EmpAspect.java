 ...
 *     {
 *     	  @Before // 핵심코딩 들어가기전에 처리 ex) getConnection()
 *     	  try
 *        {
...
public class EmpAspect {
	...
	@AfterReturning(value="execution(* com.sist.dao.EmpDAO.emp*(..))",returning="obj") //정상수행 => return 값을 받아서 처리
