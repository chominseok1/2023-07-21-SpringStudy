...
public class CommonAspect {
 ...
 {
	 HttpServletRequest request=((ServletRequestAttributes)RequestContextHolder.getRequestAttributes()).getRequest(); // 실시간 jsp전송
 ...
 public Object logData(ProceedingJoinPoint jp) throws Throwable
 {
	 ...
	 System.out.println(jp.getSignature().getName()+":메소드에 수행시작");
	 obj=jp.proceed();
