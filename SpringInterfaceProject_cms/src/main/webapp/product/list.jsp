...
<body>
	<div class="container">
	 <div class="row">	
<!-- 	   <div class="col-sm-8"> -->
	   <div class="col-md-4" v-for="vo in product_list">
		    <div class="thumbnail">
		      <a href="/w3images/lights.jpg">
		        <img :src="vo.poster" alt="Lights" style="width:200px;height:130px;">
		        <div class="caption">
		          <p style="font-size:9px">{{vo.title}}&nbsp;<span style="color:orange">{{vo.score}}</span></p>
		        </div>
		      </a>
		  </div>
		  </div>
