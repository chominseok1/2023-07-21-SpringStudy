...
public class SeoulRestController {
  ...
  @GetMapping(value="seoul/seoul_list_vue.do",produces = "text/palin;charset=UTF-8")
  ...
  @GetMapping(value="seoul/seoul_page_info_vue.do",produces = "text/palin;charset=UTF-8")
