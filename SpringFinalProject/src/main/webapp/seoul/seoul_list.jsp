      ...
      <div id="gallery">
        <figure>
          ...
          <ul class="nospace clear">
            <li v-for="vo,index in seoul_list" :class="index%4==0?'one_quarter first':'one_quarter'"><a href="#"><img :src="vo.poster" :title="vo.title" style="width:300px;height:250px"></a></li>  
          </ul>
        </figure>
      </div>
      <!-- ################################################################################################ --> 
