	  ...
	  <main class="container clear">
	  	  ...
	  	  <table class="table">
	  	  	<tr>
	  	  	 ...
	  	  	 <td width=20% class="text-center">{{board_detail.no}}</td>
	  	  	  <th width=20% class="text-center">작성일</th>
	  	  	 <td width=20% class="text-center">{{board_detail.dbday}}</td>
	  	  	</tr>
	  	  	<tr>
	  	  	 <th width=20% class="text-center">이름</th>
	  	  	 <td width=20% class="text-center">{{board_detail.name}}</td>
	  	  	  <th width=20% class="text-center">조회수</th>
	  	  	 <td width=20% class="text-center">{{board_detail.hit}}</td>
	  	  	</tr>
	  	  	<tr>
	  	  	...
	  	  	<tr>
	  	  		<td colspan="4" class="text-right">
	  	  		 <a :href="'../databoard/update.jsp?no='+no" class="btn btn-xs btn-success">수정</a>
	  	  		 <a :href="'../databoard/delete.do?no='+no" class="btn btn-xs btn-success">삭제</a>
